...
reject_grep 'FROM ops-runtime AS collector' "dockerfile-dev"
reject_grep 'COPY --from=collector_src' "dockerfile-dev"
reject_grep 'COPY --from=collector-source' "dockerfile-dev"
reject_grep 'FROM .* AS miner' "dockerfile-dev"
reject_grep 'cpu-miner' "dockerfile-dev"
reject_grep 'cpu_miner_src' "dockerfile-dev"
reject_grep 'dashboard2' "dockerfile-dev"
need_grep 'FROM ops-runtime AS status-sampler' "dockerfile-dev"
