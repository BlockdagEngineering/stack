...
need_grep 'org[.]blockdag[.]source[.]stack' "dockerfile"
need_grep 'org[.]blockdag[.]source[.]corechain' "dockerfile"
need_grep 'org[.]blockdag[.]source[.]pool' "dockerfile"
need_grep 'org[.]blockdag[.]source[.]redis-dash' "dockerfile"
need_grep 'org[.]blockdag[.]runtime[.]manifest' "dockerfile"
need_grep 'STACK_SOURCE_COMMIT: \$\{STACK_SOURCE_COMMIT:-unknown\}' "docker-compose.yml"
need_grep 'CORECHAIN_SOURCE_COMMIT: \$\{CORECHAIN_SOURCE_COMMIT:-unknown\}' "docker-compose.yml"
need_grep 'POOL_SOURCE_COMMIT: \$\{POOL_SOURCE_COMMIT:-unknown\}' "docker-compose.yml"
need_grep 'REDIS_DASH_SOURCE_COMMIT: \$\{REDIS_DASH_SOURCE_COMMIT:-unknown\}' "docker-compose.yml"
...
need_grep 'STACK_SOURCE_COMMIT=\${STACK_SOURCE_COMMIT}' ".github/workflows/build.yml"
need_grep 'CORECHAIN_SOURCE_COMMIT=\${CORECHAIN_SOURCE_COMMIT}' ".github/workflows/build.yml"
need_grep 'REDIS_DASH_SOURCE_COMMIT=\${REDIS_DASH_SOURCE_COMMIT}' ".github/workflows/build.yml"
