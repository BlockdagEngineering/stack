...
reject_grep '^addpeer=/ip4/102\.182\.77\.21/tcp/8151/p2p/' "node.conf.example"
reject_grep '^addpeer=/ip4/102\.182\.77\.16/tcp/8152/p2p/' "node.conf.example"
reject_grep '^addpeer=/ip4/3\.218\.54\.171/tcp/8150/p2p/' "node.conf.example"
reject_grep '^addpeer=/ip4/54\.214\.229\.250/tcp/8154/p2p/' "node.conf.example"
