...
STACK_SOURCE_COMMIT=""
CORECHAIN_SOURCE_COMMIT=""
POOL_SOURCE_COMMIT=""
REDIS_DASH_SOURCE_COMMIT=""
STACK_RUNTIME_MANIFEST=""
...
read_payload_metadata() {
    ...
    while IFS='=' read -r key value || [[ -n "$key" ]]; do
        case "$key" in
            ...
            STACK_SOURCE_COMMIT) STACK_SOURCE_COMMIT="$value" ;;
            CORECHAIN_SOURCE_COMMIT) CORECHAIN_SOURCE_COMMIT="$value" ;;
            POOL_SOURCE_COMMIT) POOL_SOURCE_COMMIT="$value" ;;
            REDIS_DASH_SOURCE_COMMIT) REDIS_DASH_SOURCE_COMMIT="$value" ;;
            STACK_RUNTIME_MANIFEST) STACK_RUNTIME_MANIFEST="$value" ;;
        esac
...
export STACK_SOURCE_COMMIT
export CORECHAIN_SOURCE_COMMIT
export POOL_SOURCE_COMMIT
export REDIS_DASH_SOURCE_COMMIT
export STACK_RUNTIME_MANIFEST
