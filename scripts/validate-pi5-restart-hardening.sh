...
need_grep 'BDAG_FASTSYNC_RANGE_BLOCKS 1024' "ops/install-dashboard.sh"
...
need_grep 'BDAG_NODEWORKER_LIVENESS_TIMEOUT 5m' "ops/install-dashboard.sh"
need_grep 'BDAG_CHAIN_STATE_SELF_HEAL_ENABLED 1' "ops/install-dashboard.sh"
need_grep 'BDAG_MINING_IMPERATIVE_CHAIN_STATE_RESTORE_ENABLED 1' "ops/install-dashboard.sh"
...
need_grep 'BDAG_RAWDATADIR_ACTIVE_SERVICE "node"' "ops/release-install.sh"
...
need_grep 'BDAG_FASTSYNC_RANGE_BLOCKS=1024' ".env.example"
...
need_grep 'SYNC_SOURCE_NODE=0' ".env.example"
...
need_grep 'BDAG_RAWDATADIR_ACTIVE_SERVICE=node' ".env.example"
...
need_grep 'POOL_GBT_MIN_INTERVAL_MS=1100' ".env.example"
need_grep 'POOL_GBT_PRESSURE_INTERVAL_MS=500' ".env.example"
need_grep 'POOL_GBT_PRESSURE_WINDOW_SECONDS=10' ".env.example"
need_grep 'POOL_RPC_ROUTER_NODE_HEALTH_PROBE_SECONDS=15' ".env.example"
...
need_grep 'BDAG_NODE_TMPFS_SIZE=512m' ".env.example"
need_grep 'BDAG_NODE_SHM_SIZE=512m' ".env.example"
need_grep 'BDAG_POOL_DB_CPU_SHARES=4096' ".env.example"
...
need_grep 'BDAG_STATUS_PAYLOAD_STALE_AFTER_SECONDS=120' ".env.example"
need_grep 'BDAG_STATUS_SAMPLER_MAX_AGE_SECONDS=120' ".env.example"
need_grep 'BDAG_DASHBOARD_DIRECT_STATUS_FALLBACK=0' ".env.example"
need_grep 'BDAG_DASHBOARD_STATUS_CACHE_SECONDS=120' ".env.example"
need_grep 'BDAG_DASHBOARD_SAMPLER_CACHE_SECONDS=120' ".env.example"
need_grep 'BDAG_DASHBOARD_STATUS_SAMPLE_WAIT_SECONDS=60' ".env.example"
...
need_grep 'BDAG_NODEWORKER_LIVENESS_TIMEOUT=5m' ".env.example"
...
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_THRESHOLD=3' ".env.example"
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_WINDOW_SECONDS=120' ".env.example"
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_COOLDOWN_SECONDS=60' ".env.example"
...
need_grep 'BDAG_STATUS_SAMPLER_MAX_AGE_SECONDS 120' "ops/install-dashboard.sh"
need_grep 'BDAG_DASHBOARD_STATUS_CACHE_SECONDS 120' "ops/install-dashboard.sh"
need_grep 'BDAG_DASHBOARD_DIRECT_STATUS_FALLBACK 0' "ops/install-dashboard.sh"
need_grep 'BDAG_STATUS_PAYLOAD_STALE_AFTER_SECONDS=120' "ops/portable.env.example"
need_grep 'BDAG_STATUS_SAMPLER_MAX_AGE_SECONDS=120' "ops/portable.env.example"
...
need_grep 'BDAG_RAWDATADIR_FINALIZE=1' "ops/publish-rawdatadir-artifact.sh"
...
need_grep 'BDAG_POOL_CONTAINER pool' "ops/install-dashboard.sh"
need_grep 'BDAG_POOL_DB_CONTAINER postgres' "ops/install-dashboard.sh"
need_grep 'BDAG_NODE_SERVICES node' "ops/install-dashboard.sh"
need_grep 'postgres,node,pool' "ops/install-dashboard.sh"
