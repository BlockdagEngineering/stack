...
validate_runtime_compose() {
  ...
  need_grep '^[[:space:]]+pool-db:' "docker-compose.yml"
...
need_grep 'DEFAULT_NODE_CHILD_GUARD_NODES = "node,bdag-miner-node-1"' "host/mining-appliance/bdag-node-child-guard"
...
need_grep 'migrate_legacy_env_value BDAG_STACK_SERVICES "pool-db,bdag-miner-node-1,asic-pool" "postgres,node,pool"' "ops/install-dashboard.sh"
