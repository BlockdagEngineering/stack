...
need_grep 'POOL_SUBMIT_RPC_TIMEOUT_MS=5000' ".env.example"
...
need_grep 'POOL_SUBMIT_RPC_TIMEOUT_MS: .*POOL_SUBMIT_RPC_TIMEOUT_MS' "docker-compose.yml"
...
need_grep 'POOL_SUBMIT_RPC_TIMEOUT_MS=5000' "ops/build-pi5-arm64-release.sh"
