...
need_grep 'POOL_RPC_ROUTER_NODE_HEALTH_READY_THRESHOLD=' ".env.example"
...
need_grep 'POOL_RPC_ROUTER_NODE_HEALTH_READY_THRESHOLD: .*POOL_RPC_ROUTER_NODE_HEALTH_READY_THRESHOLD' "docker-compose.yml"
