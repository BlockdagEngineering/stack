...
need_grep 'BDAG_NODE_RPC_URLS=node=http://127.0.0.1:38131' "ops/systemd/bdag-status-sampler.service"
need_grep 'BDAG_GLOBAL_CHAIN_RPC_URLS=node=http://127.0.0.1:38131' "ops/systemd/bdag-status-sampler.service"
need_grep 'DASHBOARD_EVM_RPC_URL=http://127.0.0.1:18545' "ops/systemd/bdag-status-sampler.service"
