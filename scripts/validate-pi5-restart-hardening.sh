...
need_file "ops/pool_job_timing_optimizer.py"
need_file "ops/pool_adaptive_optimizer.py"
need_file "ops/pool_adaptive_optimizer_runner.py"
...
need_file "ops/systemd/user-bdag-pool-adaptive-optimizer.service"
need_file "ops/systemd/user-bdag-pool-adaptive-optimizer.timer"
...
need_grep 'pool-adaptive-optimizer.timer' "ops/install-dashboard.sh"
need_grep 'apply_capability_profile_env' "ops/install-dashboard.sh"
need_grep 'BDAG_POOL_OPTIMIZER_WINDOW_SECONDS' "ops/install-dashboard.sh"
need_grep 'BDAG_POOL_OPTIMIZER_USE_CAPABILITY_DEFAULTS' "ops/install-dashboard.sh"
need_grep 'BDAG_POOL_OPTIMIZER_TIMER_ON_UNIT_ACTIVE_SEC' "ops/install-dashboard.sh"
reject_grep 'pool_adaptive_optimizer.py --apply --yes --iterations 1 --window-seconds 900 --sample-interval-seconds 30' "ops/install-dashboard.sh"
reject_grep 'pool_adaptive_optimizer.py --apply --yes --iterations 1 --window-seconds 900 --sample-interval-seconds 30' "ops/systemd/user-bdag-pool-adaptive-optimizer.service"
...
need_grep 'BDAG_POOL_OPTIMIZER_\*' "ops/release-install.sh"
...
need_grep 'NO_FASTSYNC_SERVE_NODE_FLAG = "--nofastsyncserve"' "ops/sync_coordinator.py"
need_grep 'node_command_disables_fastsync_serve' "ops/sync_coordinator.py"
...
need_grep 'BDAG_CAPABILITY_PROFILE=auto' ".env.example"
need_grep 'BDAG_CHAIN_DATA_PATHS=./data/node1,./data/node2,./data/postgres' ".env.example"
need_grep 'BDAG_HOST_PROFILE=auto' ".env.example"
need_grep 'BDAG_NODE_GOMEMLIMIT=off' ".env.example"
need_grep 'BDAG_POOL_GOMEMLIMIT=512MiB' ".env.example"
need_grep 'BDAG_VM_TUNING_ENABLED=1' ".env.example"
need_grep 'BDAG_VM_DIRTY_BYTES=268435456' ".env.example"
...
need_grep 'BDAG_POOL_OPTIMIZER_WINDOW_SECONDS=900' ".env.example"
need_grep 'BDAG_POOL_OPTIMIZER_USE_CAPABILITY_DEFAULTS=1' ".env.example"
need_grep 'BDAG_POOL_OPTIMIZER_SAMPLE_INTERVAL_SECONDS=30' ".env.example"
need_grep 'BDAG_POOL_OPTIMIZER_SAFE_TEMPLATE_TTL_MS=500' ".env.example"
need_grep 'BDAG_POOL_OPTIMIZER_TIMER_ON_UNIT_ACTIVE_SEC=30m' ".env.example"
need_grep 'BDAG_POOL_OPTIMIZER_RUNNER_INTERVAL_SECONDS=1800' ".env.example"
...
need_grep 'POOL_MAX_BLOCK_CANDIDATE_SAME_TEMPLATE_AGE_MS=6000' ".env.example"
...
need_grep 'BDAG_NO_FASTSYNC_SERVE' "docker/entrypoint-nodeworker.sh"
...
need_grep 'BDAG_NO_FASTSYNC_SERVE' "ops/build-pi5-arm64-release.sh"
...
need_grep 'POOL_MAX_BLOCK_CANDIDATE_SAME_TEMPLATE_AGE_MS: .*POOL_MAX_BLOCK_CANDIDATE_SAME_TEMPLATE_AGE_MS' "docker-compose.yml"
...
need_grep 'POOL_MAX_BLOCK_CANDIDATE_JOB_AGE_MS=800' "ops/build-pi5-arm64-release.sh"
need_grep 'POOL_MAX_BLOCK_CANDIDATE_SAME_TEMPLATE_AGE_MS=6000' "ops/build-pi5-arm64-release.sh"
...
need_grep 'capability_profile' "ops/capability_profile.py"
need_grep 'recommended_pool_optimizer_settings' "ops/capability_profile.py"
need_grep 'BDAG_POOL_OPTIMIZER_WINDOW_SECONDS' "ops/capability_profile.py"
need_grep 'pool_adaptive_optimizer.run_controller' "ops/pool_adaptive_optimizer_runner.py"
need_grep 'BDAG_POOL_OPTIMIZER_APPLY' "ops/pool_adaptive_optimizer_runner.py"
need_grep 'BDAG_POOL_OPTIMIZER_USE_CAPABILITY_DEFAULTS' "ops/pool_adaptive_optimizer_runner.py"
need_grep 'BDAG_POOL_OPTIMIZER_WINDOW_SECONDS' "ops/pool_adaptive_optimizer.py"
need_grep 'capability_profile' "scripts/mining-appliance-preflight.py"
need_grep 'BDAG_CHAIN_DATA_PATHS' "ops/apply-mining-host-tuning.sh"
need_grep 'vm.dirty_bytes' "ops/sysctl/99-bdag-mining.conf"
...
need_grep 'BDAG_CAPABILITY_PROFILE=auto' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_CHAIN_DATA_PATHS=./data/node1,./data/node2,./data/postgres' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_HOST_PROFILE=auto' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_NODE_GOMEMLIMIT=off' "ops/build-pi5-arm64-release.sh"
need_grep 'GOMEMLIMIT: .*BDAG_NODE_GOMEMLIMIT' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_VM_TUNING_ENABLED=1' "ops/build-pi5-arm64-release.sh"
...
need_grep 'BDAG_POOL_OPTIMIZER_WINDOW_SECONDS=900' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_POOL_OPTIMIZER_USE_CAPABILITY_DEFAULTS=1' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_POOL_OPTIMIZER_SAMPLE_INTERVAL_SECONDS=30' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_POOL_OPTIMIZER_SAFE_TEMPLATE_TTL_MS=500' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_POOL_OPTIMIZER_TIMER_ON_UNIT_ACTIVE_SEC=30m' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_POOL_OPTIMIZER_RUNNER_INTERVAL_SECONDS=1800' "ops/build-pi5-arm64-release.sh"
