...
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_THRESHOLD=3' "ops/build-pi5-arm64-release.sh"
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_WINDOW_SECONDS=120' "ops/build-pi5-arm64-release.sh"
need_grep 'POOL_EXPIRED_JOB_CLIENT_RECONNECT_COOLDOWN_SECONDS=60' "ops/build-pi5-arm64-release.sh"
...
need_grep '/var/tmp:size=.*BDAG_CONTAINER_TMPFS_SIZE.*128m' "ops/build-pi5-arm64-release.sh"
need_grep '/run/bdag-ephemeral:size=.*BDAG_NODE_TMPFS_SIZE.*512m' "ops/build-pi5-arm64-release.sh"
need_grep 'BDAG_NODE_SHM_SIZE=512m' "ops/build-pi5-arm64-release.sh"
need_grep 'scripts/bdag-low-io-build.sh' "scripts/release/installers/install-unix-common.sh"
need_grep 'def check_disk_io_noise_guard' "scripts/mining-appliance-preflight.py"
