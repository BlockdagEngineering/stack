...
def main(argv: list[str] | None = None) -> int:
    ...
    env_contains_bootstrap_node_dir = "BDAG_NODE_DATA_DIR=./node-data" in env_text
    ...
    ok = (
        ...
        and env_contains_bootstrap_node_dir
    ...
    payload: dict[str, Any] = {
        ...
        "env_contains_bootstrap_node_dir": env_contains_bootstrap_node_dir,
