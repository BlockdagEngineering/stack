...
BUILD_CONTEXT="${BDAG_FASTARTIFACT_BUILD_CONTEXT:-$(cd "$ROOT/.." && pwd)}"
DOCKERFILE="${BDAG_FASTARTIFACT_DOCKERFILE:-pool-stack-docker/dockerfile-dev}"
...
SNAPSHOT_PATH=pool-stack-docker/docker/no-snapshot.marker
NETWORK=$NETWORK
P2P_PORT=28150
BDAG_RPC_PORT=58131
EVM_HTTP_PORT=28545
