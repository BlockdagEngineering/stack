...
ensure_env_value POOL_RUNTIME_ADMIN_ENABLED true
ensure_env_value BDAG_FASTSYNC_PREPROCESS_WORKERS 1
ensure_env_value BDAG_FASTSNAP_DISCOVERY 1
ensure_env_value BDAG_FASTSNAP_DISCOVERY_LIMIT 32
ensure_env_value BDAG_FASTSNAP_DISCOVERY_TIMEOUT 20s
ensure_env_value BDAG_FASTSYNC_ARTIFACT_MANIFEST_TTL 24h
