...
Environment=BDAG_PROJECT_ROOT=$PROJECT_ROOT
Environment=BDAG_RUNTIME_DIR=$RUNTIME_DIR
Environment=BDAG_WATCHDOG_INTERVAL=15
Environment=BDAG_WATCHDOG_FAILURE_THRESHOLD=3
Environment=BDAG_CLEAN_RESTORE_COOLDOWN=1800
Environment=BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_CONFIRM_SECONDS=15
Environment=BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_JOB_AGE_SECONDS=20
EnvironmentFile=-$ENV_FILE
