...
FILES=(
  ...
  "ops/p2p_guard.py"
  "ops/pool_adaptive_optimizer.py"
  "ops/pool_adaptive_optimizer_runner.py"
  "ops/pool_job_timing_optimizer.py"
  ...
  "ops/tests/test_pool_job_timing_optimizer.py"
  ...
  "ops/systemd/user-bdag-pool-adaptive-optimizer.service"
  "ops/systemd/user-bdag-pool-adaptive-optimizer.timer"
  ...
  "ops/sysctl/99-bdag-mining.conf"
