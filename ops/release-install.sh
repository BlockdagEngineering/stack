...
configure_env() {
  ...
  # Refreshes intentionally reset sync-protection defaults. Preserve chain data,
  # discovered peer evidence, wallet identity, LAN settings, and ASIC MAC filters;
  # stale local throttling/sampler overrides must not survive a rebuild.
  ...
  set_env_value .env BDAG_SYNC_PRIORITY_ENABLED 1
  set_env_value .env BDAG_SYNC_PRIORITY_MIN_LAG_BLOCKS 25
  set_env_value .env BDAG_SYNC_PRIORITY_DEFER_DASHBOARD_SAMPLERS 1
  ...
  set_env_value .env BDAG_SHARED_STATUS_CACHE_ENABLED 1
  set_env_value .env BDAG_SHARED_STATUS_CACHE_SECONDS 3.0
  set_env_value .env BDAG_STATUS_PAYLOAD_STALE_AFTER_SECONDS 120
  set_env_value .env BDAG_DASHBOARD_DIRECT_STATUS_FALLBACK 0
  set_env_value .env BDAG_DASHBOARD_STATUS_CACHE_SECONDS 120
  set_env_value .env BDAG_DASHBOARD_SAMPLER_CACHE_SECONDS 120
  set_env_value .env BDAG_DASHBOARD_STATUS_SAMPLE_WAIT_SECONDS 60
  set_env_value .env BDAG_WATCHDOG_EARNINGS_SNAPSHOT_INTERVAL_SECONDS 60
  set_env_value .env BDAG_STATUS_SAMPLER_EARNINGS_SNAPSHOT_INTERVAL_SECONDS 60
  set_env_value .env BDAG_DASHBOARD_EARNINGS_SAMPLER_INTERVAL_SECONDS 60
  set_env_value .env BDAG_DASHBOARD_GLOBAL_SAMPLER_INTERVAL_SECONDS 60
  set_env_value .env BDAG_GLOBAL_RPC_WORKERS 24
  set_env_value .env BDAG_GLOBAL_BLOCK_WINDOW 600
  set_env_value .env BDAG_GLOBAL_DEFERRED_BLOCK_WINDOW 0
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_BACKOFF_ENABLED 1
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_SYNC_BACKOFF_BLOCKS 0
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_IOWAIT_WARN_PERCENT 25
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_IO_SOME_AVG10_WARN 20.0
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_CPU_SOME_AVG10_WARN 80.0
  set_env_value .env BDAG_BACKGROUND_MAINTENANCE_CHAIN_RPC_WARN_MS 1000
