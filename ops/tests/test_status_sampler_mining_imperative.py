...
class StatusSamplerMiningImperativeTests(unittest.TestCase):
    def setUp(self) -> None:
        self.originals = {
            ...
            for name in (
                ...
                "MINING_IMPERATIVE_ORPHAN_PEER_QUARANTINE_ENABLED",
        ...
        status_sampler.MINING_IMPERATIVE_ORPHAN_PEER_QUARANTINE_ENABLED = True
    ...
    def test_quarantines_peer_returning_only_orphan_blocks(self) -> None:
        commands = []
        env_updates = {}
        ...
        payload["nodes"] = {
            "node": {
                "tail": [
                    "sync range returned only orphan blocks; falling back to peer download "
        ...
        self.assertIn("quarantined_orphan_peer", repair["actions"])
