...
"""
    ...
    def test_compose_dashboard_targets_stack_container_names(self) -> None:
        ...
        self.assertIn("BDAG_STATUS_SOURCE_URL: ${BDAG_STATUS_SOURCE_URL:-}", compose)
        self.assertIn("BDAG_STATUS_SOURCE_PREFER_HTTP: ${BDAG_STATUS_SOURCE_PREFER_HTTP:-0}", compose)
    ...
    def test_release_runtime_excludes_retired_collector_and_cpu_miner(self) -> None:
        ...
        self.assertIn(
            "BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_MIN_LEAD_BLOCKS: "
            "${BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_MIN_LEAD_BLOCKS:-30}",
            watchdog_block,
        )
        self.assertIn(
        ...
        self.assertIn(
            "BDAG_WATCHDOG_NODE_TEMPLATE_SYNC_WEDGE_SOFT_LEAD_BLOCKS: "
            "${BDAG_WATCHDOG_NODE_TEMPLATE_SYNC_WEDGE_SOFT_LEAD_BLOCKS:-20}",
            watchdog_block,
        )
