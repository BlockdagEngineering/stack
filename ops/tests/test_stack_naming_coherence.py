...
class StackNamingCoherenceTests(unittest.TestCase):
    ...
    def test_env_examples_and_installer_use_current_names(self) -> None:
        ...
        self.assertIn("BDAG_STACK_SERVICES=postgres,node,pool,dashboard", installer)
        ...
        self.assertIn("ensure_env_value BDAG_STACK_SERVICES \"postgres,node,pool,dashboard\"", installer)
    ...
    def test_release_installer_generates_current_runtime_topology(self) -> None:
        ...
        self.assertIn('set_env_value .env BDAG_STACK_SERVICES "postgres,node,pool,dashboard"', installer)
