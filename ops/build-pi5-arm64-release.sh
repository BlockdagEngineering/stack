...
services:
  asic-pool:
    ...
    environment:
      ...
      POOL_ALLOW_MULTIPLE_BLOCK_CANDIDATES_PER_JOB: ${POOL_ALLOW_MULTIPLE_BLOCK_CANDIDATES_PER_JOB:-false}
...
POOL_RPC_ROUTER_NODE_HEALTH_MAX_AGE_SECONDS=10
POOL_RPC_ROUTER_NODE_HEALTH_UNREADY_THRESHOLD=3
POOL_RPC_ROUTER_NODE_HEALTH_ERROR_THRESHOLD=3
...
POOL_ALLOW_MULTIPLE_BLOCK_CANDIDATES_PER_JOB=false
EOF
