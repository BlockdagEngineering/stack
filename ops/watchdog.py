...
DEFAULT_NODE_RPC_REFUSED_CONFIRM_SECONDS = int(
    os.environ.get("BDAG_WATCHDOG_NODE_RPC_REFUSED_CONFIRM_SECONDS", "180")
)
DEFAULT_NODE_RPC_REFUSED_REPAIR_COOLDOWN = int(
    os.environ.get("BDAG_WATCHDOG_NODE_RPC_REFUSED_REPAIR_COOLDOWN", "900")
)
...
DEFAULT_NODE_PEER_LEAD_HARD_STALL_CONFIRM_SECONDS = max(
    180,
    int(os.environ.get("BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_CONFIRM_SECONDS", "180")),
)
...
DEFAULT_NODE_PEER_LEAD_HARD_STALL_JOB_AGE_SECONDS = max(
    90,
    int(os.environ.get("BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_JOB_AGE_SECONDS", "90")),
)
...
DEFAULT_NODE_PEER_LEAD_HARD_STALL_RETRY_COOLDOWN = int(
    os.environ.get("BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_RETRY_COOLDOWN", "300")
)
...
DEFAULT_NODE_PEER_LEAD_HARD_STALL_ACTIVE_IMPORT_MAX_WAIT_SECONDS = int(
    os.environ.get("BDAG_WATCHDOG_NODE_PEER_LEAD_HARD_STALL_ACTIVE_IMPORT_MAX_WAIT_SECONDS", "180")
)
DEFAULT_NODE_TEMPLATE_SYNC_WEDGE_CONFIRM_SECONDS = int(
    os.environ.get("BDAG_WATCHDOG_NODE_TEMPLATE_SYNC_WEDGE_CONFIRM_SECONDS", "300")
)
