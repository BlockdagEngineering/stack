...
mkdir -p "$TMPDIR/backup/last-known-good" "$TMPDIR/outside" "$TMPDIR/backup/not-runs/good"
ln -s "$TMPDIR/outside" "$TMPDIR/backup/last-known-good/current"
run_lib_fail "BACKUP_ROOT='$TMPDIR/backup'; resolve_latest_lkg"
rm "$TMPDIR/backup/last-known-good/current"
ln -s "$TMPDIR/backup/not-runs/good" "$TMPDIR/backup/last-known-good/current"
run_lib_fail "BACKUP_ROOT='$TMPDIR/backup'; resolve_latest_lkg"
rm "$TMPDIR/backup/last-known-good/current"
ln -s "$TMPDIR/backup/runs/good" "$TMPDIR/backup/last-known-good/current"
run_lib_pass "BACKUP_ROOT='$TMPDIR/backup'; resolve_latest_lkg"
